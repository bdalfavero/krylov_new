...
from tensor_network_common import mpo_mps_exepctation
from fermion_helpers import total_number_qubit_operator
...
def main():
    ...
    eigvals, eigvecs = eigsh(hamiltonian_sparse, k=2, which="SA")
    ...
    if i_min == 0:
        ...
        excited_energy = eigvals[0]
    else:
        raise ValueError(f"i_min = {i_min}")
